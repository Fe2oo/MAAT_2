...
<form class="form-horizontal" action="{{route('purchase.store') }}" enctype="multipart/form-data" method="post">
    ...
    <div class="card-body">
        <div class="form-group row">
            <label for="place" class="col-sm-3 text-end control-label col-form-label">Place of residence</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="place" placeholder="Place" name="place" value="" required>
            </div>
        </div>
        <div class="form-group row">
